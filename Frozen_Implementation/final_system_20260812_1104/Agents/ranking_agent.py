...
def compute_final_score(
    ...
    # Apply a budget penalty only when
    # the query contains a valid positive budget.
    if budget > 0:
...
"""
    ...
    def rank_products(
        ...
        # -------------------------------------------------
        # Assign ranks before generating explanations
        # -------------------------------------------------
        ...
        # -------------------------------------------------
        # One LLM call for only the top N products
        # -------------------------------------------------
